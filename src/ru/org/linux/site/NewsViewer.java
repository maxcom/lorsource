  ...
  public String showCurrent() throws IOException, SQLException, UtilException {
    ...
    if (image != null) {
      ...
      try {
        ...
        out.append("<img src=\"/").append(profile.getStringProperty("style")).append(image).append("\" ").append(info.getCode()).append(" border=0 alt=\"Группа ").append(res.getString("gtitle")).append("\">");
