...
case class Image(@BeanProperty id: Int, @BeanProperty topicId: Int, @BeanProperty original: String,
                  @BeanProperty deleted: Boolean, @BeanProperty purged: Boolean = false) {
