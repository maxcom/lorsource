...
/** Периодическое окончательное удаление старых удалённых топиков и черновиков неактивных пользователей.
  ...
  *   - '''Удалённые топики''': топик удалён более 3 лет назад (по `del_info.deldate`; удалениям до начала ведения даты
  *     — `deldate IS NULL`, сообщения до 2010 года — порог считается заведомо пройденным), не имеет комментариев
  *     (включая удалённые) и непрочищенных картинок, а его автор не заходил на сайт более 10 лет, либо заблокирован и
  *     не заходил более 3 лет, либо не имеет дат регистрации и последнего входа (в т.ч. anonymous);
