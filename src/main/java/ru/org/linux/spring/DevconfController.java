...
public class DevconfController {
  ...
  @RequestMapping(value = "/devconf2012", method = RequestMethod.POST)
  public ModelAndView add(HttpServletRequest request, @RequestParam("msg") String msg) throws Exception {
    ...
    if (info.getRegistrationDate() != null && info.getRegistrationDate().after(new Date(112, 4, 15))) {
      throw new UserErrorException("Дата регистрации после 15/05/2010");
    }

    if (!"devconf2012".equals(msg)) {
