 ...
 */
public class RepliesListItemDto implements Serializable {
  ...
  public RepliesListItemDto(int cid, UserDto cAuthor, Timestamp cDate, String messageText, String groupTitle,
