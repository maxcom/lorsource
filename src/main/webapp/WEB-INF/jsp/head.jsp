...
<c:if test="${template.style=='tango'}">
  <c:if test="${not pageContext.request.secure}">
    <link href='http://fonts.googleapis.com/css?family=Droid+Sans+Mono|Open+Sans:400italic,400,700&amp;subset=latin,cyrillic' rel='stylesheet' type='text/css'>
  </c:if>
  <c:if test="${pageContext.request.secure}">
    <link href='https://fonts.googleapis.com/css?family=Droid+Sans+Mono|Open+Sans:400italic,400,700&amp;subset=latin,cyrillic' rel='stylesheet' type='text/css'>
  </c:if>
</c:if>
