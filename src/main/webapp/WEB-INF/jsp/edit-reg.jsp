...
<form:form modelAttribute="form" method="POST" action="/people/${nick}/edit" id="editRegForm">
    ...
    <dl>
        ...
        <dd><form:textarea path="info" cols="60" rows="10" cssErrorClass="error"/><form:errors path="info" element="label" cssClass="error"/><span class="help-block"><a href="/wiki/en/Lorcode" target="_blank" title="справка откроется в новом окне">справка по разметке LORCODE</a></span></dd>
