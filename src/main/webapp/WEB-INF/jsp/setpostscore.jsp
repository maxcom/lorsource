...
<%@ page import="ru.org.linux.dto.MessageDto" %>
<%--
...
<%
  MessageDto msg = (MessageDto) request.getAttribute("message");
...
<form method=POST action="setpostscore.jsp">
  ...
  <select name="postscore">
    <option <%= postscore==MessageDto.POSTSCORE_UNRESTRICTED?"selected":"" %> value="<%= MessageDto.POSTSCORE_UNRESTRICTED %>">без ограничений</option>
    <option <%= postscore==MessageDto.POSTSCORE_REGISTERED_ONLY?"selected":"" %> value="<%= MessageDto.POSTSCORE_REGISTERED_ONLY %>">для зарегистрированных</option>
    ...
    <option <%= postscore==MessageDto.POSTSCORE_MOD_AUTHOR?"selected":"" %> value="<%= MessageDto.POSTSCORE_MOD_AUTHOR%>">только для модераторов и автора</option>
    <option <%= postscore==MessageDto.POSTSCORE_MODERATORS_ONLY?"selected":"" %> value="<%= MessageDto.POSTSCORE_MODERATORS_ONLY%>">только для модераторов</option>
  </select>
    </label>
    <br>
