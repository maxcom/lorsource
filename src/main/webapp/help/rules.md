...
* Модератор может быть сняте со своего поста в таких случаях.
    ...
    3. Если оне не посещает сайт и/или не пишет в модераторскую рассылку в течение трёх месяцев. Если модератор
       подтверждает свою неактивность, за нем остаётся звание почётного (без реальных модераторских полномочий). Также
       за нем закрепляется право читать модераторскую рассылку и писать в неё. Почётный модератор может быть возвращене
       на пост действующего модератора при явном изъявлении соответствующего желания, если никто из действующих
       модераторов не высказалесь против этого. Если же неактивный модератор не отвечает на запросы от модераторского
       состава по электронной почте, то оне снимается с поста без сохранения каких-либо званий и привилегий.
...
* Кандидат должне сообщить о своём желании по e-mail (пишите на maxcom <собака> linux.org.ru либо любому модератору,
...
* Далее кандидатура рассматривается модераторами в списке рассылки, проводится голосование среди действующих
  ...
  неделю.
* Корректор может быть сняте со своего поста в таких случаях.
    1. По собственному желанию.
...
В случае систематических нарушений пользователь может быть заблокироване:

* пользователь с нулевым рейтингом (без звёзд любого цвета) может быть заблокироване автоматически при достижении
  определённого порога, а также по решению модератора;
* пользователь с рейтингом «одна звезда любого цвета» может быть заблокироване автоматически при достижении
  определённого порога, а также по результатам голосования модераторов;
* пользователь с рейтингом «две и более звезды любого цвета» может быть заблокироване по результатам голосования
...
Если пользователь опубликовале свой пароль в открытом виде или в том виде, который позволит воспользоваться ее логином третьим лицам, то логин бессрочно блокируется без возможности восстановления.
