...
Если вы хотите сообщить об ошибке в работе движка сайте, это можно сделать в [официальном репозитории](https://github.com/maxcom/lorsource/issues).
...
## Разделы форума с ограниченным доступом
  ...
  - [Talks](https://www.linux.org.ru/forum/talks/) ограничен на чтение для пользователей чей рейтинг ниже 50.
