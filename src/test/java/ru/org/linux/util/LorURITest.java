...
public class LorURITest {
  ...
  public void test1() throws Exception {
    ...
    assertEquals("https://127.0.0.1:8085/news/debian/6753486?cid=6753612", lorURI.formatJump(messageDao, groupService, canon));
  }
  ...
  public void test3() throws Exception {
    ...
    assertEquals("https://127.0.0.1:8085/forum/general/6890857?cid=6892917", lorURI.formatJump(messageDao, groupService, canon));
  }
  ...
  public void test12() throws Exception {
    ...
    assertTrue(lorURI.isMessageUrl());
    assertTrue(lorURI.isCommentUrl());
    assertEquals("https://127.0.0.1:8085/forum/security/1948661?cid=1948668", lorURI.formatJump(messageDao, groupService, canon));
  }
  ...
  public void test14() throws Exception {
    ...
    assertEquals("https://127.0.0.1:8085/forum/general/6890857?cid=6892917", lorURI1.formatJump(messageDao, groupService, canon));
    ...
    assertEquals("https://127.0.0.1:8085/forum/general/6890857?cid=6892917", lorURI2.formatJump(messageDao, groupService, canon));
  }
  ...
  public void test15() throws Exception {
    ...
    assertEquals("https://127.0.0.1:8085/forum/linux-org-ru/6944260?cid=6944831", lorURI1.formatJump(messageDao, groupService, canon));
    ...
    assertEquals("https://127.0.0.1:8085/forum/linux-org-ru/6944260?cid=6944831", lorURI2.formatJump(messageDao, groupService, canon));
  }
