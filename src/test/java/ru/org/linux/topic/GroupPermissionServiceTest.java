...
public class GroupPermissionServiceTest {
  /**
   * Проверка, что пользователь МОЖЕТ удалить топик, автором которого оне является,
  ...
  /**
   * Проверка, что пользователь НЕ МОЖЕТ удалить топик, автором которого оне является,
  ...
  /**
   * Проверка, что пользователь НЕ МОЖЕТ удалить топик, автором которого оне не является,
   * и прошло больше часа с момента постинга
   * @throws Exception
   */
  @Test
